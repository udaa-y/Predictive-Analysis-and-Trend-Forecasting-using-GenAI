...
if 'Gross Profit' not in financials.columns or 'Total Revenue' not in financials.columns:
...
data = financials[['Gross Profit']].reset_index()
...
print(f"Predicted Last Quarter Gross Profit: {predicted_last_quarter_eps}")
print(f"Actual Last Quarter Gross Profit: {actual_last_quarter_eps}")
