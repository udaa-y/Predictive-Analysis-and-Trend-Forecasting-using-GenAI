...
if 'Normalized Income' not in financials.columns or 'Total Revenue' not in financials.columns:
...
data = financials[['Normalized Income']].reset_index()
...
print(f"Predicted Last Quarter Normalized Income: {predicted_last_quarter_eps}")
print(f"Actual Last Quarter Normalized Income: {actual_last_quarter_eps}")
