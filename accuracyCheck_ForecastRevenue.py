...
if 'Total Revenue' not in financials.columns or 'Total Revenue' not in financials.columns:
...
data = financials[['Total Revenue']].reset_index()
...
print(f"Predicted Last Quarter Revenue: {predicted_last_quarter_eps}")
print(f"Actual Last Quarter Revenue: {actual_last_quarter_eps}")
